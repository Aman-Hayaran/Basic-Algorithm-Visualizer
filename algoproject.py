...
class Drawinformation:
    ...
    def set_list(self, lst):  # set bunch of attributes for the list
        self.lst = lst
...
def main():  # pygame event loop # render screen
    run = True
    ...
    while run:
        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:  # click the red 'x'on top right
                run = False
